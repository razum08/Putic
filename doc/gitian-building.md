...
git clone https://github.com/razum08/putic.git
cd putic
...
```bash
    ...
    From https://github.com/razum08/putic
...
[putic/gitian.sigs](https://github.com/razum08/gitian.sigs/) repository, or if that's not possible to create a pull
request.
