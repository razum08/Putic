...
git clone https://github.com/puticcoin/putic.git
cd putic
...
```bash
    ...
    From https://github.com/puticcoin/putic
...
[putic/gitian.sigs](https://github.com/puticcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
